...
// THIS IS FOR THIS LECTURE: I will be using MongoDB Compass bcos i don't want to be connected to internet
// So now that u know the basics of Mongoose by implementing all the four CRUD operatns, its now time to finally model our tour data a bit better
// in order to make the tours more complete. So at this pt, our tour docs can only have a name, a rating, and a price. But of course, we need so
// much more data in the above tourSchema, bcos the goal is to have a very data-rich API.
// From the final version of this app, u'll see that we have a lot of data. So we will start adding more data to our tourModel
