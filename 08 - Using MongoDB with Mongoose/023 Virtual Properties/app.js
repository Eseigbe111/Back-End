...
// THIS IS FOR THIS LECTURE:=> Over to tourModel.js.
// So far in this sectn, we have talked about Mongoose models, CRUD operatns with Mongoose we did a lot of querying, and we learned about
// the aggregatn pipeline, but now for the next couple of vdeos, let's actually return to ur data model and learn sm super useful features
// that Mongoose offers us in order to model our data. And the 1st one we gonna talk about are VIRTUAL PPTS.
//  So let's move over to tourModel.js
