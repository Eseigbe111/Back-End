// This contains the code catchAsync() b4 we moved it to catchasnyc.js and then used it for all the handler fcs here
...
1) The fc call i.e "fn(req, res, next)" has no way of knowing "req, res, and next". We did not pass them into the "catchAsync()"  and really there's 
