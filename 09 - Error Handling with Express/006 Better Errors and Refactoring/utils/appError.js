...
// error class like this "class AppError extends Error"(Error is from javascript) as seen below:
...
class AppError extends Error {
  ...
  constructor(message, statusCode) {
    ...
    this.isOperational = true; // All our errors will get this ppt set to true. And i did this so that later we can then test for this ppt and
