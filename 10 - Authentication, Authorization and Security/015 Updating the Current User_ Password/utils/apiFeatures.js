class APIFeatures {
  ...
  limitFields() {
    ...
    if (this.queryString.fields) {
      ...
      // const fields = this.queryString.fields.split(',').join(''); // This is used to show how to debug in this lecture
  ...
  paginate() {
    ...
    /// We removed the code that was initially here bcos, if u think about it, requesting the next page, which has 0 reasult, is
    // not really an error. The fact that there are bo results is enough for the user to realize that, basically, the page that
