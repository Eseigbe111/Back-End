...
// THIS IS FOR THIS LECTURE:=> This will be done in "authController.js" and "userRoute.js"
// So let's now create based on the model we implemmented in the last video. So we will do most of te users related stuff
// like creating new users, logging users in, or updating passwords in the authentication controller. So all of the stuff
// that's related to autentication really, is not gonna be in the user controller that we actually created b4, but instead
// we will create an authentication controller. So all the stuff that are related to authentication will go there.
