...
// THIS IS FOR THIS LECTURE:=> This will be done in "userModel.js"
// Authentication and Authorization, is all about signing up, logging in, and accessing pages or routes, that we grant them permission to do so.
// So, it's really all about the users. And, so we need to start by implementing the user model in this lecture, so that in the next one, we can
// then create new users in our database. So let's go a head to create the "userModel.js" file in our models folder.
/////
